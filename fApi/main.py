...
from model.api import predict_ghi, predict_realtime_solar_irradiance
from model.data.download_data import download_data_file

# Download data file on startup
download_data_file()
...
# Update allow_origins with your frontend's actual URL on Vercel.
origins = [
    "http://localhost:3000",  # For local development
    "https://your-frontend-app-name.vercel.app",  # Replace with your Vercel URL
]
