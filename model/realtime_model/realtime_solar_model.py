...
# --- REMOVE OR COMMENT OUT TRAINING SCRIPT ENTRYPOINT AND TOP-LEVEL TRAINING CODE ---
# All code outside of function definitions (data loading, model training, saving, and evaluation) should be commented out or removed.
# Only keep the predict_realtime_ghi function and its dependencies.
